...
;(function(w, d){
	...
	function initPlayer(){
		...
		if(tabSource[tabIndex].type === 'player'){
			playerBox.html(`<iframe webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen="" style="height: ${frameH};border: none;width: 100%;background: #343434;" class="player-frame" src="/player/index.html?${curUrlInfo[1]}" />`);
		}else if(tabSource[tabIndex].type === 'iframe'){
			playerBox.html(`<iframe webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen="" style="height: ${frameH};border: none;width: 100%;background: #343434;" class="player-frame" src="${curUrlInfo[1]}" />`);
		}
		// 历史
